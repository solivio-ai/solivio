...
/**
 * Shared API contract vocabulary. Modules describe their HTTP routes in
 * `src/contracts/` using these types; the generated contracts registry merges
 * them into the OpenAPI document.
 */
